# VERSION 2: all data legges i en sheet
...
def funk(site, page, total_ads_that_we_want_to_collect_data_from):
    ...
    for ad in all_ads_on_site:
        ...
        ws.append([titles.text, final_product_price])
        count += 1
...
funk('https://www.finn.no/bap/forsale/search.html?abTestKey=suggestions&sort=RELEVANCE&sub_category=1.93.3907', 1, 102)
